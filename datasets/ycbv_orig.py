...
backgrounds_path = glob.glob('./YCB_Video_Dataset/backgrounds/nvidia/nvidia4/*.png')
...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": ( "./YCB_Video_Dataset", './YCB_Video_Dataset/train.json'),
        "test": ( "./YCB_Video_Dataset", './YCB_Video_Dataset/test.json'),
    }
