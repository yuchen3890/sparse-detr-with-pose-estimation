...
def get_args_parser():
    ...
    # * Matcher
    parser.add_argument('--set_cost_class', default=1, type=float, # 1
                        help="Class coefficient in the matching cost")
    parser.add_argument('--set_cost_bbox', default=1, type=float, # 1
    ...
    parser.add_argument('--cls_loss_coef', default=1, type=float) # 1
    parser.add_argument('--bbox_loss_coef', default=1, type=float) # 1
